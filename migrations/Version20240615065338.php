 ...
 */
final class Version20240615065338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_item (id INT NOT NULL, product_id INT NOT NULL, order_id INT NOT NULL, cost INT NOT NULL, quantity INT NOT NULL, PRIMARY KEY(id))');
